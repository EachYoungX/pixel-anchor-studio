; Based on Tauri's official tauri-v2.11.5 NSIS template.
; Upstream SHA-256: 20f4ecc730defb71f1342eaeaec4021df13be3d843abba0effe88ea5835fa079
; Local changes are limited to the Pixel Anchor Studio wizard pages, default
; per-user install location, and shortcut behavior.
Unicode true
...
Section Uninstall
  ...
  ; Pixel Anchor Studio's build-generated manifest is the authoritative list
  ; for application-owned install files. The upstream deletes below remain as
  ; a compatibility fallback and are intentionally non-recursive.
  !ifmacrodef NSIS_HOOK_MANIFEST_UNINSTALL
    !insertmacro NSIS_HOOK_MANIFEST_UNINSTALL
  !endif
