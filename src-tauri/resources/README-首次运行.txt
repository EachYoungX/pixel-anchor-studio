...
5. 当前 Windows 版本尚未进行代码签名。请只从官方 GitHub 仓库的 Actions Artifact 或 Release 下载并核对 SHA-256；出现 SmartScreen 提示时点击“更多信息”，检查应用名称后再选择“仍要运行”。不要关闭 SmartScreen，也不要从第三方网站下载安装包。

PowerShell 校验示例：
Get-FileHash .\PixelAnchorStudio-1.0.0-Portable.zip -Algorithm SHA256
